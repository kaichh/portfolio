...
export const metadata = {
  title: "KC Huang",
  description: "KC is a software engineer studying MCS @TAMU.",
};
    ...
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36
                   dark:bg-gray-900 dark:text-gray-50 dard:text-opacity-90 dark:bg-opacity-90`}
      >
        {/* <div
        ...
        ></div>
        <div
          className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[-35rem] h-[50rem] 
